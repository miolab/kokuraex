defmodule Kokuraex.Services.NewsFunction do
  ...
  @typep latest_release_information_map :: %{
  ...
  """
  @spec github_latest_release_information(
          String.t(),
          String.t()
        ) :: latest_release_information_map()
  ...
  """
  @spec hex_latest_release_information(String.t()) :: latest_release_information_map()
